...
namespace CRM.Controllers
{
    public class Vendor : Controller
    {
        ...
        //            ViewBag.Aadhartwo = "";
        //            ViewBag.Panimg = "";
        //            ViewBag.Heading = "Add PresnolInfo";
        ...
        //                    ViewBag.Heading = "Update PresnolInfo";
        //                    ViewBag.BtnText = "UPDATE";
        //                }
        //            }
        //            List<EmployeeApprovedPresnolInfo> EmployeePresnolInfo = await _IHirejob.ApprovedPresnolInfoList();
        ...
        //            {
        //                var panImageName = _IUploadImage.uploadImage(model.Panbase64, "Employeedocument");
        //                if (panImageName != "not allowed")
        //                {
        //                    model.Panimg = $"{schema}://{host}/Employeedocument/" + panImageName;
        //                }
        //            }
        ...
        //                var aadharTwoImageName = _IUploadImage.uploadImage(model.Aadharbase64[1], "Employeedocument");

        //                if (aadharOneImageName != "not allowed")
        //                {
        //                    model.AadharOne = $"{schema}://{host}/Employeedocument/" + aadharOneImageName;
        //                }

        //                if (aadharTwoImageName != "not allowed")
        //                {
        //                    model.AadharTwo = $"{schema}://{host}/Employeedocument/" + aadharTwoImageName;
        //                }
        //            }
        //            bool isAddedOrUpdated = await _IHirejob.AddApprovedPresnolInfo(model);
        //            if (isAddedOrUpdated)
        //            {
        ...
        //                }
        //            }
        //            List<ApprovedbankdetailList> Approvedbankdetail = await _IHirejob.ApprovedbankdetailList();
        ...
        //            {
        //                var chequeImageName = _IUploadImage.uploadImage(model.Chequebase64, "Employeedocument");
        //                if (chequeImageName != "not allowed")
        //                {
        //                    model.Chequeimage = $"{schema}://{host}/Employeedocument/" + chequeImageName;
        //                }
        //            }
        //            bool isAddedOrUpdated = await _IHirejob.AddApprovedbankdetail(model);
        //            if (isAddedOrUpdated)
        //            {
        //                TempData["msg"] = model.id > 0 ? "Record has been updated successfully." : "Record has been added successfully.";
        //            }
